<script>
	...
	const redirect = () => {
		goto(
			'https://dev.are.na/oauth/authorize?client_id=uXoqEVgURo0Y1xSLuoxZVmm1_O4YtMHkmquXNiaC184&redirect_uri=https%3A%2F%2Flocalhost%3A5173%2Fauth&response_type=code&scope='
		);
	};
...
<header class="flex flex-col gap-8 justify-center items-center h-[50vh] text-4xl">
	<svg
		...
		/></svg
	>
	<h1>are.na duplicate blocks checker</h1>
</header>

<section class="flex justify-center">
	<Button outline size="lg" on:click={redirect}>Authenticate with are.na</Button>
</section>
